...
const ImportCountryExcel = ({ handleCountries }) => {
    ...
    const validateAndTransformData = (data) => {
        ...
        data.forEach((row) => {
            let structuredItem = {
                ...
                iso3: row?.iso3,
                numcode: row?.numcode,
                states_required: row?.states_required,
                zipcode_required: row?.zipcode_required,
            };
    ...
    const onSubmit = async (data) => {
        ...
        setIsSubmiting(true)
        await post('countries/create', { countries: structuredData })
            .then((result) => {
                if (result.success) {
                    ...
                    <form className="mt-4 space-y-4" onSubmit={handleSubmit(onSubmit)}>
                        <div className="">
                            ...
                            >
                                ...
                                {isLoading ? <Spinner /> : 'Import Countries Data File'}
                                <input
                                    type="file"
                                    ref={fileInputRef}
                                    hidden
...
export default ImportCountryExcel;