...
const ImportAddressExcel = () => {
    ...
    const onSubmit = async (data) => {
        ...
        setIsSubmiting(true)
        await post('address/import', { addresses: structuredData })
            .then((result) => {
                if (result.success) {
                    ...
                    <form className="mt-4 space-y-4" onSubmit={handleSubmit(onSubmit)}>
                        <div className="">
                            ...
                            >
                                ...
                                {isLoading ? <Spinner /> : 'Import Addresses Data File'}
                                <input
                                    type="file"
                                    ref={fileInputRef}
                                    hidden
...
export default ImportAddressExcel;