...
export function UserAddresses({ isUserEdit = false }) {
    ...
    const handleAddressUpdate = async (data) => {
        ...
        try {
            ...
            if (response.success) {
                ...
                dispatch(setCustomerData({ ...rowData, billingAddress: response?.billingAddress, shippingAddress: response?.shippingAddress, }))
            }
        } catch (error) {
            console.log(error)
            handleError(error)
            ...
            <>
                <form onSubmit={handleSubmit(handleAddressUpdate)} className="space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        {!isSameAddress && <div className="grid grid-cols-2 gap-4 max-sm:grid-cols-1">
