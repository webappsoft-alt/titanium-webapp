...
const ImportTitaniumUser = ({ handleGetUser }) => {
    ...
    const onSubmit = async (data) => {
        ...
        setIsSubmiting(true)
        await post('users/import/titanium', { titaniumData: structuredData })
            .then((result) => {
                if (result.success) {
                    ...
                    <form className="mt-4 space-y-4" onSubmit={handleSubmit(onSubmit)}>
                        <div className="">
                            ...
                            >
                                ...
                                {isLoading ? <Spinner /> : 'Import Titanium User Data File'}
                                <input
                                    type="file"
                                    ref={fileInputRef}
                                    hidden
...
export default ImportTitaniumUser;